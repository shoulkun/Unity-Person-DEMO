...
[Serializable]
public class MainCameraScriptableRendererData : ScriptableRendererData
{

#if UNITY_EDITOR
    [MenuItem("Assets/Create/Rendering/Main Camera Renderer", priority = CoreUtils.Priorities.editMenuPriority)]
    ...
    internal class CreateCustomRendererAsset : EndNameEditAction
    {
        ...
        {
            var instance = CreateInstance<MainCameraScriptableRendererData>();
    ...
    {
        return new MainCameraScriptableRenderer(this);
    }
}